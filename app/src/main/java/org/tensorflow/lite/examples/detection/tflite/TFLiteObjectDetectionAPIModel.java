...
public class TFLiteObjectDetectionAPIModel implements Classifier {
  ...
  private static MappedByteBuffer loadModelFile(String uriFile)
      throws IOException {
    ...
    try {
      ...
      myMappedBuffer =  channel.map(FileChannel.MapMode.READ_ONLY, 0, file.length());
    } catch (IOException e) {
      e.printStackTrace();
    }

    return myMappedBuffer;
  }
  ...
  public static Classifier create(
    ...
    try {
      d.tfLite = new Interpreter(loadModelFile(modelFilename));
    } catch (Exception e) {
